...
import model.GradeSubmissionModel;
 ...
 * @author CITS-TEST
 */
public class SetGradeSubmissionController implements Initializable {

    @FXML
    private Button btnStudentClearance;
    @FXML
    private Label lblStudentClearance;
    ...
    private GradeSubmissionModel GradeSubmissionModel = new GradeSubmissionModel();
    ...
    private void setStudentClearanceToggle() {
        ...
        isUpdated = GradeSubmissionModel.setSySemActive(selectedSy, selectedSem);
