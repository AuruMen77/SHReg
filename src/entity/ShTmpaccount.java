...
/**
 * ShTmpaccount generated by hbm2java
 */
@Entity
@Table(name="sh_tmpaccount"
    ,catalog="seniorhighdb"
)
public class ShTmpaccount  implements java.io.Serializable {
    ...
    public ShTmpaccount(String accntid, String idnum) {
        this.accntid = accntid;
        this.idnum = idnum;
    }
    public ShTmpaccount(String accntid, Boolean assessFlag, String idnum, String itemcode, BigDecimal itemfee, String itemname, Byte pmode, Date transdate, Date ts) {
       this.accntid = accntid;
