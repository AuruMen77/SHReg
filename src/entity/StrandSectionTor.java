...
/**
 * StrandSectionTor generated by hbm2java
 */
@Entity
@Table(name="strand_section_tor"
    ,catalog="seniorhighdb"
)
public class StrandSectionTor  implements java.io.Serializable {
    ...
    public StrandSectionTor() {
    }

	
    public StrandSectionTor(Date ts) {
        this.ts = ts;
    }
    public StrandSectionTor(Integer gradeLevel, Integer sem, String strand, String strandgroup, String studSection, String sy, Date ts) {
